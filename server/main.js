...
if (Venues.find().count() < 1) {
	console.info('creating test data - Users and Roles','main.js');
	var allRoles=[
		'admin',
		'manage-users',
		'spectator',
	...
	var users = [
		{name: "PW", email: "paul.wujek@gmail.com", roles: ['admin', 'test', 'admin-users', 'spectator', 'official', 'manage-users', 'update-regatta']},
		{name: "HWK", email: "hwknapp@gmail.com", roles: ['spectator', 'admin', 'test', 'official' ]},
		{name: "CG", email: "clete.graham@gmail.com", roles: ['spectator', 'admin', 'test', ' official' ]},
